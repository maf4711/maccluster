...
| | |
|---|---|
| GitHub | `maf4711/maccluster` |
| SSH | `git@github.com:maf4711/maccluster.git` |
| Remote dieses Checkouts | `git@github.com:maf4711/maccluster.git` |
| Ordner | `~/Developer/maccluster` |
| Default-Branch | `main` |
...
3. Dieser Checkout liegt danach unter `~/Developer/maccluster`. Weicht der Ordner vom Repo-Namen ab, weil zwei Orgs denselben Namen haben, heißt er `~/Developer/<owner>--<name>`.
