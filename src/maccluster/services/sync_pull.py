...
def _transfer_large_files_pull(
    ...
    *,
    ...
    for i, rel in enumerate(rels, 1):
        ...
        dest = contained_path(local_home, rel)
        if dest.is_symlink():
            raise ValueError(f"refusing large-file pull through symlink: {rel!r}")
